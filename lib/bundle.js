...
/***/ function(module, exports) {
	...
	GameView.prototype.start = function () {
	  ...
	  this.lastTime = 0;
	    alert("Welcome to Hamilton Asteroids! Today, you will be fighting your ideological enemy, Thomas Jefferson. Use the arrow keys to move and the spacebar to shoot. Avoid the Jeffersons and eliminate them all!");
	  //start the animation
